...
| 当前执行阶段                     | 维护 5.5 `COMPLETE`；Wave 6 `READY` | M01、M02 及本次 submission persistence closure 已完成实施、定向测试、轻量审计、finding 修复、提交、合并和新 clean integration HEAD 全量门禁；不进入 Wave 6                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 当前集成 HEAD                    | `fff0f96`                           | branch `codex/article-lifecycle-submission`；完整测试与合规 evidence 均绑定该 clean HEAD；其后仅允许提交本计划的完成状态与证据，不改变源码、测试、schema、脚本或门禁                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 下一可执行项                     | Wave 6 / Ticket 09 `READY`          | 等待用户明确调度；不得自动开始 Ticket 09                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| 5.5（维护）                      | M01 → M02                                                                                                                     | 波次 5 `COMPLETE`；M02←M01                                                                        | `READY`    |
| 6                                | 09 → 14 → 15                                                                                                                  | 09←08；14←13；15←09、11、13；且维护 5.5 `COMPLETE`                                                | `PENDING`  |
