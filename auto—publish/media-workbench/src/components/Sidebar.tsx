  ...
  return (
    <aside id="app-sidebar" className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col h-screen text-slate-300 select-none">
      ...
      <div className="p-6 border-b border-slate-800 flex items-center space-x-3">
        ...
        <div>
          <h1 className="font-bold text-slate-100 text-base leading-tight tracking-tight">Media Work</h1>
          <span className="text-[10px] text-slate-400 tracking-wider font-semibold uppercase">自媒体智能分发台</span>
        </div>
      </div>
