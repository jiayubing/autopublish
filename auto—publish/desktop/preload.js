...
const api = {
  ...
  media: {
    ...
    listResources: function(opts) { return api.media.refreshResources(opts); },
    getCachedResources: function(opts) { return api.media.getResourcePage(opts); },
    searchResources: function(keyword) { return api.media.searchResourcePage({ keyword: keyword }); },
