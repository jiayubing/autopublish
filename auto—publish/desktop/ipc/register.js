...
function registerIpc(deps) {
  ...
  const attention = require("./article-attention-ipc").registerArticleAttentionIpc(Object.assign({}, guarded, {
    archiveIssueReader: guarded.archiveIssueReader || platform && platform.archiveIssueReader
  }));
