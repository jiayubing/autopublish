...
function createOperationalContentSubmissionService(options) {
  ...
  function previewRetryFailedPublication() {
    return {
      publicationId: null,
      requiresConfirmation: true,
      eligible: false,
      reasonCode: "PUBLICATION_RETRY_REQUIRES_WORKFLOW",
    };
  }
  function retryFailedPublication() {
    throw fail(
      "PUBLICATION_RETRY_REQUIRES_WORKFLOW",
      "Failed publication retry belongs to PublicationWorkflow",
    );
  }
