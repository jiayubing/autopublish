...
function normalizeGeoBaseUrl(value) {
  ...
  if (![CODING_BASE_URL, STANDARD_BASE_URL].includes(baseUrl)) throw geoError("GEO_CONFIG_INVALID");
  return baseUrl;
}
module.exports = { CODING_BASE_URL, STANDARD_BASE_URL, normalizeGeoBaseUrl };
