...
describe("publication target resolution", function() {
  it("resolves ordinary platforms at platform granularity", function() {
    assert.deepEqual(resolvePublicationTarget({ platformId: "toutiao" }), {
      kind: "platform",
      platformId: "toutiao",
  ...
  it("rejects undeclared platforms and unsafe identifiers", function() {
    ...
    assert.throws(() => resolvePublicationTarget({ platformId: "toutiao/other" }), { code: "PUBLICATION_PLATFORM_UNDECLARED" });
