...
const PRODUCTION_CALLERS = Object.freeze({
  ...
  "platform.submitSelected": Object.freeze({
    ...
    featureSymbol: "usePlatformFeature",
    bridge: "media-workbench/src/bridge/platform.ts",
    bridgeSymbol: "submitPlatformSelection",
  ...
  "content.previewSubmissionBatch": Object.freeze({
    ...
    featureSymbol: "useContentWorkbenchFeature",
    bridge: "media-workbench/src/bridge/content.ts",
    bridgeSymbol: "previewContentSubmissionBatch",
    preloadMethod: "previewSubmissionBatch",
    command: "content.previewSubmissionBatch",
    channel: "content:preview-submission-batch",
    registrar: "desktop/ipc/content-submission-ipc.js",
    application: "workflow.preparation.previewBatch",
    featureBinding: "previewContentSubmissionBatch",
  }),
  ...
  "content.createSubmissionBatch": Object.freeze({
    ...
    featureSymbol: "useContentWorkbenchFeature",
    bridge: "media-workbench/src/bridge/content.ts",
    bridgeSymbol: "createContentSubmissionBatch",
    preloadMethod: "createSubmissionBatch",
    command: "content.createSubmissionBatch",
    channel: "content:create-submission-batch",
    registrar: "desktop/ipc/content-submission-ipc.js",
    application: "workflow.preparation.createBatch",
    featureBinding: "createContentSubmissionBatch",
  }),
  ...
  "publication.reconcile": Object.freeze({
    view: "media-workbench/src/components/ContentWorkbench.tsx",
    viewSymbol: "useContentWorkbenchFeature",
    feature:
      "media-workbench/src/features/content/use-content-workbench-feature.ts",
    featureSymbol: "useContentWorkbenchFeature",
    bridge: "media-workbench/src/bridge/publication.ts",
    bridgeSymbol: "reconcilePublicationHistory",
    preloadMethod: "reconcile",
