...
7. 运行大批量文章/队列/订单投影基准，证明无 N+1；运行模块职责与规模观察、依赖方向、legacy absence、安全、typed IPC、全测试、Renderer build 和生产打包门禁。
...
- [ ] 模块职责审计与规模观察已完成并记录，依赖方向、legacy absence、安全、typed IPC、全测试、构建和打包门禁全部通过。
