...
| Ticket 16 | `READY` | Lane 下一串行项；必须从 Ticket 10 closure HEAD 重新 preflight |
...
| 7 | 10 → 16 | 10←09；16←15；Wave 6 COMPLETE 仅由授权 lane 豁免 | `RUNNING`（10 COMPLETE；16 next） |
