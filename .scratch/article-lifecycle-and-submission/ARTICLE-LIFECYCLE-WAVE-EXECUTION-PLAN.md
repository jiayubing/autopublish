...
| 13   | 列举网 19-0 → 19-A → 19-B → 19-C → 19-D → 19-E → 19-F → 19-G → 授权后的列举网真实带图验收 | Wave 12 COMPLETE；列举网探索已为 `SUPPORTED`；真实验收另行授权 | `RUNNING`；19-0、19-A、19-B、19-C、19-D=`COMPLETE`，19-E=`READY`；Ticket 20/21 已移出当前 Wave，未来是否实施由独立计划重新决定 |
