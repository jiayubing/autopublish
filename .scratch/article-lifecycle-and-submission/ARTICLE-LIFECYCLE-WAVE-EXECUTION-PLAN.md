...
| 10.5 | M04-A → M04-B → M04-C → M05 → M06                        | Wave 10 COMPLETE                                         | `RUNNING`；M04-A COMPLETE，已进入新的 clean integration HEAD；M04-B 为当前下一项，M04-C/M05/M06 未启动 |
